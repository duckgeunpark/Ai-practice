...
# qwen_lora_adapter 등 어댑터 폴더를 LLM_Fine-tuning 안에서 찾고,
# unsloth_compiled_cache 등 새 폴더도 같은 위치에 생성되도록 함
...
# ═══════════════════════════════════════
# 3. LLM-as-Judge — GPT로 응답 품질 자동 평가
# ═══════════════════════════════════════
print("\n" + "=" * 60)
print("3. LLM-as-Judge (OPENAI_API_KEY 환경변수 필요)")
print("=" * 60)
